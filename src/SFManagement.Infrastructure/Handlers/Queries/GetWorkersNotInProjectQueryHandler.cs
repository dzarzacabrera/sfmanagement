...
internal sealed class GetWorkersNotInProjectQueryHandler(INpgsqlConnectionFactory connectionFactory)
    : IGetWorkersNotInProjectQueryHandler
{
    public async Task<IReadOnlyList<WorkerDto>> HandleAsync(GetWorkersNotInProjectQuery query)
    {
