(function () {
    ...
    window.showUndoToast = function (message, onUndo) {
        var toast = document.createElement('div');
        toast.className = 'pointer-events-auto flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg text-sm font-medium bg-brand text-white translate-x-full opacity-0 transition-all duration-300';
